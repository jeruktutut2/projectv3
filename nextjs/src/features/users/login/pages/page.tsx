        ...
        <div className="fixed top-1/2 left-1/2 max-w-[720px] w-full transform -translate-x-1/2 -translate-y-1/2 border-2">
            <div className="flex flex-wrap md:flex-nowrap flex-col md:flex-row w-full">
                ...
                <div className="w-full p-[35px]
                    ...
                    <button type="submit" className="h-[40px] w-full outline-none border-0 text-[0.80rem] font-semibold rounded-[3px] mt-1 text-white cursor-pointer bg-blue-500 hover:bg-blue-400 active:bg-blue-600 disabled:bg-blue-700" disabled={pending} formAction={action}>{pending ? "Logging in..." : "Login"}</button>
